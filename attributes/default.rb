...
default['hygieia_liatrio']['collectors']	= %w(api-2.0.4.jar udeploy-deployment-collector-2.0.4.jar jira-feature-collector-2.0.4.jar github-scm-collector-2.0.4.jar sonar-codequality-collector-2.0.4.jar bitbucket-scm-collector-2.0.4.jar jenkins-build-collector-2.0.4.jar)
